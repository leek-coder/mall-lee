...
import com.huatech.mall.properties.NotAuthUrlProperties;
...
public class AuthorizationFilter implements GlobalFilter, Ordered, InitializingBean {
    ...
    @Autowired
    private CustomerRestTemplate restTemplate;
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if(StringUtils.isEmpty(authHeader)) {
            ...
            throw new ExceptionCustomer(ApiErrorCodeEnum.AUTHORIZATION_HEADER_IS_EMPTY);
        }
