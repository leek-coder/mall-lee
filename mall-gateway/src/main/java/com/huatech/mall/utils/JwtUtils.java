...
public class JwtUtils {
     ...
     */
    private static String getTokenKeyByRemoteCall(RestTemplate restTemplate) throws ExceptionCustomer {
        ...
        try {
            ...
            throw new ExceptionCustomer(ApiErrorCodeEnum.GET_TOKEN_KEY_ERROR);
        }
    }
     ...
     */
    public static PublicKey genPulicKey(RestTemplate restTemplate) throws ExceptionCustomer {
        ...
        try{
            ...
            throw new ExceptionCustomer(ApiErrorCodeEnum.GEN_PUBLIC_KEY_ERROR);
        }
    }
    ...
    public static Claims validateJwtToken(String authHeader,PublicKey publicKey) {
        ...
        try{
            ...
            throw new ExceptionCustomer(ApiErrorCodeEnum.JWT_TOKEN_EXPIRE);
        }
    }
}
